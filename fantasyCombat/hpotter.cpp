...
int Hpotter::defense(int attack)
{
	...
	if (strength <= 0 && deaths == 0)
	{
		...
		cout << name << ": Harry Potter has used the power of hogwarts to come back to life and this time he's stronger.  Don't mess with a wizard!" << endl;
		strength = 20;
		deaths = 1;
	}
...
{
	cout << "The wizard has smote you!" << endl;
}
