...
int Bluemen::defense(int attack)
{
	...
	if (strength > 0)
	{
		...
		{
			defNumDice = 2;
			cout << "The mob has been weakened. The number of defending dice is now 2" << endl;
		}
		else if (startStrength > 4 && strength <= 4)
		{
			defNumDice = 1;
			cout << "The mob has been severely weakened.  The number of defending dice is now 1" << endl;
		}
	}
